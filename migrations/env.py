...
# This allows different database URLs in dev/staging/production
# NOTE: Alembic requires synchronous database driver
...
# Import application Base for autogenerate support
# This enables Alembic to detect model changes automatically
sys.path.insert(0, str(Path(__file__).resolve().parent.parent))
from src.mcp_server.models.base import Base  # noqa: E402
