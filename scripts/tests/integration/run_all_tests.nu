...
def main [
    ...
    # Define test suites
    let suites = [
        {name: "Setup Flow (End-to-End)", script: "scripts/tests/integration/test_setup_flow.nu", args: [], enabled: true, tag: "flow"}
        {name: "Error Scenarios", script: "scripts/tests/integration/test_error_scenarios.nu", args: [], enabled: true, tag: "error"}
        {name: "Silent Mode (CI/CD)", script: "scripts/tests/integration/test_silent_mode.nu", args: [], enabled: true, tag: "silent"}
        {name: "Performance Benchmarks", script: "scripts/tests/integration/test_performance.nu", args: (if $quick { ["--quick"] } else { [] }), enabled: true, tag: "perf"}
        {name: "Platform Compatibility", script: "scripts/tests/integration/test_platform_compat.nu", args: [], enabled: true, tag: "platform"}
    ]
